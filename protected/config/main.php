...
return array(
	...
	'components'=>array(
		...
		'urlManager'=>array(
            ...
            'rules'=>array(
                '<alias:contactus|aboutus|careers|faqs|newsevents|dinein|membership|showtiming>' => 'cinestar/<alias>',
            ),
...
//			'db'=>array(
//	//		'connectionString' => 'mysql:host=localhost;dbname=thearenadb',
//			'connectionString' => 'mysql:host=localhost;dbname=cinegold_plex_db',
//			'emulatePrepare' => true,
//			//'username' => 'root',
//			//'password' => '',
//			'username' => 'sofTideo',
//			'password' => 'oneCl@out123',
//			'charset' => 'utf8',
//		),
            'db'=>array(
	//		'connectionString' => 'mysql:host=localhost;dbname=thearenadb',
			'connectionString' => 'mysql:host=localhost;dbname=softtota_arena',
			'emulatePrepare' => true,
			//'username' => 'root',
			//'password' => '',
			'username' => 'root',
...
//		'db'=>array(
//			'connectionString' => 'mysql:host=cinestarnew.db.9107584.hostedresource.com;dbname=cinestarnew',
//			'emulatePrepare' => true,
//			'username' => 'cinestarnew',

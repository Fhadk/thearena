		...
		<div class="col_12">
			...
			<ul class="menu">
				...
				<li><a>Gallery</a>
                    ...
                    <li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/AddWeeklyDeal">Weekly deals</a></li>
                    <li class="divider"></li>
                    <li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/AddBrandPartner">Add Brand Partners</a></li>
                    <li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/BrandPartnerList">Brand Partners List</a></li>
					</ul>
				</li>
				...
				<li><a>Movies Schedule</a>
					<ul>
                                  ...
                                  <li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/AboutUs">About Us</a>
					
				</li>
                                <li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/ContactUs">Contact Us</a>
				...
				<li class="right"><a>Dine In Menu</a>
					<ul>
					<li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/DineInMenuList">Menu List</a></li>
					<li class="divider"></li>
					<li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/AddDineInMenu">Add New Menu</a></li>
					</ul>
				</li>
				<li class="right"><a>Dine In SLider</a>
					<ul>
					<li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/DineInList">Slider List</a></li>
					<li class="divider"></li>
					<li><a href="<?php echo Yii::app()->request->baseUrl?>/index.php/Admin/AddDineInSlider">Add New Slider</a></li>
					</ul>
				</li>

                ...
                if(isset($slidersequence)){
                    for($i=0;$i<count($slidersequence);$i++){
                        ...
                        <div data-thumb="<?php echo Yii::app()->getBaseUrl(true) . $slidersequence[$i]['movie_img_path'];?>" data-src="<?php echo Yii::app()->getBaseUrl(true) . $slidersequence[$i]['slider_img_path'];?>">
                            <div class="camera_caption moveFromBottom" style="right: auto; visibility: visible; top: 385px;">

                                <div class="movie-title"><i><?php echo $slidersequence[$i]['movie_name']; ?></i></div>
                                <div class="movie-details"><i>
                                <?php echo $slidersequence[$i]['movie_desc']; ?></i>
                                </div>
                            </div>
                        </div>
                    <?php }} ?>
    ...
    <div class="fullwidthbanner-container slider-main">
        <div class="fullwidthabnner">
            <ul id="revolutionul" style="display:none;">
                ...
                <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/bg1.jpg" alt="">
                ...
                <div class="caption lfb"
                     ...
                     data-start="1000"
                     data-easing="easeOutExpo"  >
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/man-winner.png" alt="Image 1">
                </div>
            </li>
                ...
                <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/bg2.jpg" alt="">
                ...
                <div class="caption lfr slide_item_right"
                    ...
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/mac.png" alt="Image 1">
                </div>
                <div class="caption lfr slide_item_right"
                     data-x="580"
                     data-y="245"
                     ...
                     data-start="2000"
                     data-easing="easeOutBack">
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/ipad.png" alt="Image 1">
                </div>
                <div class="caption lfr slide_item_right"
                     data-x="735"
                     data-y="290"
                     ...
                     data-start="2500"
                     data-easing="easeOutBack">
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/iphone.png" alt="Image 1">
                </div>
                <div class="caption lfr slide_item_right"
                     data-x="835"
                     data-y="230"
                     ...
                     data-start="3000"
                     data-easing="easeOutBack">
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/macbook.png" alt="Image 1">
                </div>
                <div class="caption lft slide_item_right"
                     ...
                     data-start="5000"
                     data-easing="easeOutBack">
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/hint1-blue.png" id="rev-hint1" alt="Image 1">
                </div>
                <div class="caption lfb slide_item_right"
                     ...
                     data-start="5500"
                     data-easing="easeOutBack">
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/hint2-blue.png" id="rev-hint2" alt="Image 1">
                </div>
                ...
                <!-- THE THIRD SLIDE -->
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="assets/img/sliders/revolution/thumbs/thumb2.jpg">
                <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/bg3.jpg" alt="">
                ...
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="assets/img/sliders/revolution/thumbs/thumb2.jpg">
                <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/bg4.jpg" alt="">
                ...
                <div class="caption lft start"
                     ...
                     data-start="2000"
                     data-easing="easeOutBack"  >
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/iphone_left.png" alt="Image 2">
                </div>
                ...
                <div class="caption lft start"
                     ...
                     data-start="2400"
                     data-easing="easeOutBack"  >
                    <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/sliders/revolution/iphone_right.png" alt="Image 3">
                </div>
            </li>
    ...
    <div class="row recent-work margin-bottom-40">
        ...
        <div class="col-md-9">
            <ul class="bxslider">
                <li>
                    <em>
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/works/img1.jpg" alt="" />
                ...
                <li>
                    <em>
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/works/img2.jpg" alt="" />
                        <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                ...
                <li>
                    <em>
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/works/img3.jpg" alt="" />
                        <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                ...
                <li>
                    <em>
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/works/img4.jpg" alt="" />
                        <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                ...
                <li>
                    <em>
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/works/img5.jpg" alt="" />
                        <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                ...
                <li>
                    <em>
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/works/img6.jpg" alt="" />
                        <a href="portfolio_item.html"><i class="icon-link icon-hover icon-hover-1"></i></a>
                ...
                <div class="tab-pane row fade in active" id="tab-1">
                    <div class="col-md-3">
                        <a href="assets/img/photos/img7.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                            <img class="img-responsive" src="<?php echo Yii::app()->request->baseUrl?>/theme/img/photos/img7.jpg" alt="" />
                        </a>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="tab-pane row fade" id="tab-2">
                    ...
                    <div class="col-md-3">
                        <a href="assets/img/photos/img10.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                            <img class="img-responsive" src="<?php echo Yii::app()->request->baseUrl?>/theme/img/photos/img10.jpg" alt="" />
                        </a>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    <div class="active item">
                        ...
                        <div class="carousel-info">
                            <img class="pull-left" src="<?php echo Yii::app()->request->baseUrl?>/theme/img/people/img1-small.jpg" alt="" />
                            <div class="pull-left">
                    ...
                    <div class="item">
                        ...
                        <div class="carousel-info">
                            <img class="pull-left" src="<?php echo Yii::app()->request->baseUrl?>/theme/img/people/img5-small.jpg" alt="" />
                            <div class="pull-left">
                    ...
                    <div class="item">
                        ...
                        <div class="carousel-info">
                            <img class="pull-left" src="<?php echo Yii::app()->request->baseUrl?>/theme/img/people/img2-small.jpg" alt="" />
                            <div class="pull-left">
    ...
    <div class="row margin-bottom-40 our-clients">
        ...
        <div class="col-md-9">
            <ul class="bxslider1 clients-list">
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_1_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_1.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_2_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_2.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_3_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_3.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_4_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_4.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_5_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_5.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_6_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_6.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_7_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_7.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_8_gray.png" alt="" />
                        <img src="<?php echo Yii::app()->request->baseUrl?>/theme/img/clients/client_8.png" class="color-img" alt="" />
                    </a>
                </li>
            </ul>
        </div>

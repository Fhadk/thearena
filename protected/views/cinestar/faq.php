    ...
    <div class="carousel_thumbnail slide" id="myCarousel">
        ...
        <div class="carousel-inner">
            <div class="item active" data-slide-number="0">
                <div class="banner_bg1" style="background:url('arena_images/Banners/FAQ.png') no-repeat;background-size:cover;background-position:center;">
        ...
        <div class="lightgrey_bg">
            <div class="row">
                <div class="col-md-12" style="padding-left: 20px;padding-right: 20px;padding-top: 40px;">
                    <div class="col-md-4">
                        <h2 class="">Arena Stubs</h2>
                        <p style="line-height: 2;">Do you have questions about Arena's loyalty program? We've got answers to all of the most frequently asked questions about Arena Stubs™ and more!</p>
                        <div class="button-container text-center">
                            <button style="text-transform: capitalize" type="button"  class="btn">Arena Stubs FAQs</button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h2 class="">Movie Info</h2>
                        <p style="line-height: 2;">You’re a click away from MPAA ratings, Now Playing and what’s Coming Soon. Finding movie information fast is that easy.
                        </p>
                        <div class="button-container text-center">
                            <button style="text-transform: capitalize" type="button"  class="btn">Movie FAQs</button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h2 class="">Business Info</h2>
                        <p style="line-height: 2;"> Want to request a donation or tickets? Want to advertise in theatre or to purchase group tickets? This section can tell you more about opportunities for businesses at Arena.</p>
                        <div class="button-container text-center">
                            <button style="text-transform: capitalize" type="button"  class="btn">Business FAQs</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12" style="padding-left: 20px;padding-right: 20px;padding-top: 40px;">
                    <div class="col-md-4">
                        <h2 class="">Corporate Info</h2>
                        <p style="line-height: 2;">Want information on how Arena got its start in the movie industry and facts about our company today? This section has all our     corporate information, news releases and the history of Arena.</p>
                        <div class="button-container text-center">
                            <button style="text-transform: capitalize" type="button"  class="btn">Corporate FAQs</button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h2 class="">Cinema Info</h2>
                        <p style="line-height: 2;">Want to learn about our theatres? Here you'll find answers on our code of conduct, concessions at our theatres as well as how to rent a theatre for a professional meeting or private showing.</p>
                        <div class="button-container text-center">
                            <button style="text-transform: capitalize" type="button"  class="btn">Cinema FAQs</button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h2 class="">Tickets and Passes</h2>
                        <p style="line-height: 2;">Need information on tickets, passes, gift cards? Learn about what "No Passes" and "Special Engagement" actually mean and the restrictions on how passes can be used  (with surcharges) to see just about anything.</p>
                        <div class="button-container text-center">
            ...
            <div class="row">
                <div class="col-md-12" style="padding-left: 20px;padding-right: 20px;padding-top: 40px;">
                    <div class="col-md-4" style="min-height: 180px;">
                        <h2 class="">Group Sales</h2>
                        <p style="line-height: 2;">Find out more about Group Ticket Sales in the FAQs.</p>
                        <div class="button-container text-center">
                            <button style="text-transform: capitalize" type="button"  class="btn">Group Sale FAQs</button>
                        </div>
                    </div>
                </div>
            </div>

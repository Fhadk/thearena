...
<!--[if lt IE 9]>
<script src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/respond.min.js"></script>
<![endif]-->
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/hover-dropdown.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/back-to-top.js"></script>
<!-- END CORE PLUGINS -->

<!-- BEGIN PAGE LEVEL JAVASCRIPTS(REQUIRED ONLY FOR CURRENT PAGE) -->
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/fancybox/source/jquery.fancybox.pack.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/revolution_slider/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/revolution_slider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl?>/theme/plugins/bxslider/jquery.bxslider.min.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl?>/theme/scripts/app.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl?>/theme/scripts/index.js"></script>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl ?>/css/cinestar/row-grid.css" />
    ...
    <div class="carousel_thumbnail slide" id="myCarousel">
        ...
        <div class="carousel-inner">
            <div class="item active" data-slide-number="0">
                <div class="banner_bg1" style="background:url('arena_images/Banners/Gallery.png') no-repeat;background-size:cover;background-position:center;">
                    <div class="banner_text">
                        <h1>Our Events and Gallery </h1>
                        <p style="padding-left: 15%;padding-right: 15%;"> The Arena also facilitates its valued customers with The Arena Exclusive membership. The Arena exclusive    members can avail following benefits.</p>
                    </div>
                </div>
            </div>
        </div><!-- Carousel nav -->
        ...
        <div class="lightgrey_bg">
            <div class="row">
                <div class="col-md-12" style="padding-left: 20px;padding-right: 20px;padding-top: 40px;">
                    <div class="col-md-8">
                        <h2 class="main_heading">Latest<span> News</span> </h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12" style="padding-left: 20px;padding-right: 20px;padding-top: 40px;">
                    <div class="col-md-4">
                        <img src="arena_images/News.png" style="width:100%">
                    </div>
                    <div class="col-md-8">
                        <h4>Smart App For Mobile </h4>
                        <p style="line-height: 2;">Pakistan's First exclusive Mobile App (Android) for Cinema has been launched, please click on Android Icon to download it.</p>
                    </div>
                </div>
            </div>
        </div>
        <hr style=" border: 2px solid #eee;">
        <div class="lightgrey_bg" style="margin-bottom: 100px">
            <div class="row">
                <div class="col-md-12" style="padding-left: 20px;padding-right: 20px;padding-top: 40px;">
                    <div class="col-md-8">
                        <h2 class="main_heading">Events<span> Gallery</span> </h2>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="col-md-12" id="grid">
                        ...
                        <?php for($i=0; $i<count($results);$i++){ ?>
                            <!-- image 1 -->
                            <div class="item">
                                <a href="<?php echo Yii::app()->request->baseUrl . $resultsfilename[$i]; ?>" rel="prettyPhoto" title="<?php echo $results[$i];?>"><img src="<?php echo Yii::app()->request->baseUrl . $resultsfilename[$i]; ?>" alt="" width="320" height="200" rel="prettyPhoto"></a>
                                <p style="line-height: 2;"><?php echo $results[$i]; ?></p>
                            </div>
                            <?php
                        }
                        ?>
...
<!--                    --><?php //for ($i = 0; $i < count($results); $i++) { ?>
<!--                    <div class="col-md-4">-->
<!--                        <img src="--><?php //echo Yii::app()->getBaseUrl(true) . $resultsfilename[$i]; ?><!--" style="width:100%">-->
<!--                        <p style="line-height: 2;">--><?php //echo $results[$i]; ?><!--</p>-->
<!--                    </div>-->
<!--                    --><?php //} ?>
<!--                    <div class="col-md-4">-->
<!--                        <img src="arena_images/Gallery-Album01.png" style="width:100%">-->
<!--                        <p style="line-height: 2;text-align:center">Dekh Magar Pyaar Say Premier ISB</p>-->
<!--                    </div>-->
<!--                    <div class="col-md-4">-->
<!--                        <img src="arena_images/Gallery-Album02.png" style="width:100%">-->
<!--                        <p style="line-height: 2;text-align:center">Captain America Civil War Premier ISB</p>-->
<!--                    </div>-->
<!--                    <div class="col-md-4">-->
<!--                        <img src="arena_images/Gallery-Album03.png" style="width:100%">-->
<!--                        <p style="line-height: 2;text-align:center">Spectre 007 Premiere ISB</p>-->
<!--                    </div>-->
<!--                    <div class="col-md-4">-->
<!--                        <img src="arena_images/Gallery-Album04.png" style="width:100%">-->
<!--                        <p style="line-height: 2;text-align:center">The Arena Orchard Lahore Event</p>-->
<!--                    </div>-->
<!--                    <div class="col-md-4">-->
<!--                        <img src="arena_images/Gallery-Album05.png" style="width:100%">-->
<!--                        <p style="line-height: 2;text-align:center">Fast and the Furious 7 Premier LHR</p>-->
<!--                    </div>-->
<!--                    <div class="col-md-4">-->
<!--                        <img src="arena_images/Gallery-Album06.png" style="width:100%">-->
<!--                        <p style="line-height: 2;text-align:center">3rd Anniversary Arena Islamabad</p>-->
<!--                    </div>-->
<!--                </div>-->
            </div>
        </div>
...
<script src="<?php echo Yii::app()->getBaseUrl(true)?>/js/cinestar/jquery.row-grid.js"></script>
